...
import 'package:hackers_news/features/news_details/views/widgets/related_articles.dart';

class NewsDetailsBody extends GetView<DetailsController> {
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            CustomText(
              text: controller.newsDetails.value.title ?? '',
            ...
            Row(
              children: [
                ...
                CustomText(
                  text: controller.newsDetails.value.date ?? '',
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 5),
                CustomText(
                  text: controller.newsDetails.value.refrence ?? '',
                  fontSize: AppSize.small_2,
                ),
              ],
            ),
            ...
            const SizedBox(height: 5),
            CustomText(
              text: controller.newsDetails.value.content ?? '',
